-- Kanban board schema
-- Run this in the Supabase SQL editor before running the app locally.
-- Prerequisite: enable Anonymous Sign-ins in Authentication -> Providers (dashboard-only toggle).
...
create policy "Users can select their own team members"
